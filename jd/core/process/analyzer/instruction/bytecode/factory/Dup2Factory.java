...
public class Dup2Factory extends InstructionFactory {
   public int create(ClassFile classFile, Method method, List<Instruction> list, List<Instruction> listForAnalyze, Stack<Instruction> stack, byte[] code, int offset, int lineNumber, boolean[] jumps) {
      ...
      if(!"J".equals(signature1) && !"D".equals(signature1)) {
         Instruction i21 = (Instruction)stack.pop();
         DupStore dupStore1 = new DupStore(264, offset, lineNumber, i1);
         DupStore dupStore2 = new DupStore(264, offset, lineNumber, i21);
         list.add(dupStore1);
         list.add(dupStore2);
         ...
         DupStore i2 = new DupStore(264, offset, lineNumber, i1);
         list.add(i2);
         stack.push(i2.getDupLoad1());
         stack.push(i2.getDupLoad2());
      }
