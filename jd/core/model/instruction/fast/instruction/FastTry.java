...
public class FastTry extends FastList {
   public List<FastTry.FastCatch> catches;
   public List<Instruction> finallyInstructions;

   public FastTry(int opcode, int offset, int lineNumber, int branch, List<Instruction> instructions, List<FastTry.FastCatch> catches, List<Instruction> finallyInstructions) {
   ...
   public static class FastCatch {
      ...
      public FastCatch(int offset, int exceptionOffset, int exceptionTypeIndex, int[] otherExceptionTypeIndexes, int localVarIndex, List<Instruction> instructions) {
         this.offset = offset;
